...
ggsave(here("study5", "figs_preso", "fig00_pract-choice-by-gender-and-cond-bar.png"), p, width = 7, height = 7)
...
ggsave(here("study5", "figs_preso", "fig01_pract-choice-by-gender.png"), p, width = 7, height = 7)
...
ggsave(here("study5", "figs_preso", "fig02_perceived-prac-dev-by-gender.png"), p, width = 7, height = 7)
...
ggsave(here("study5", "figs_preso", "fig03_perc-task-gender-pract.png"), p, width = 7, height = 7)
...
ggsave(here("study5", "figs_preso", "fig04_perc-gen-gender-pract.png"), p, width = 7, height = 7)
...
ggsave(here("study5", "figs_preso", "fig05_perc-gender-comp-F.png"), p, width = 7, height = 7)
...
ggsave(here("study5", "figs_preso", "fig06_better-gender-guess.png"), p, width = 7, height = 7)
...
ggsave(here("study5", "figs_preso", "fig07_perc-gender-comp-M.png"), p, width = 7, height = 7)
...
clean_fraud_removed %>%
  ...
  opt_align_table_header(align = "left") %>% gt::gtsave(., file = here("study5","figs_preso", "demographics-table-conds-study5.png"))
...
ggsave(here("study5", "figs_preso", "pract-choice-by-gender-and-perc-task-prep-bar-study5.png"), p, width = 7, height = 7)
...
ggsave(here("study5", "figs_preso", "pract-choice-by-gender-and-perc-gen-prep-bar-study5.png"), p, width = 7, height = 7)

# creating panel plots ----------------------------------------------------

img1 <- magick::image_read(here::here("study5", "figs_preso", "fig00_pract-choice-by-gender-and-cond-bar.png"))
img2 <- magick::image_read(here::here("study5", "figs_preso", "fig01_pract-choice-by-gender.png"))

panel_study5 <- magick::image_append(c(img1, img2))

image_write(panel_study5, path = here::here("study5", "figs_preso", "panel_study5.png"), format = "png")
...
tab_model(sec_exploratory25, hypothesis1, sec_exploratory13, file = here("study5", "figs_preso","tab_pract-choice-study5.html"),  dv.labels = c("(1)", "(2)", "(3)")) 
webshot(here("study5", "figs_preso","tab_pract-choice-study5.html"), here("study5", "figs_preso","tab_pract-choice-study5.png"), selector = "table", zoom= 2)

## Task scores as DV: 

tab_model(sec_exploratory12, sec_exploratory37, sec_exploratory4, file = here("study5", "figs_preso","tab_task-scores-study5.html"), dv.labels = c("(1)", "(2)", "(3)"))
webshot(here("study5", "figs_preso","tab_task-scores-study5.html"), here("study5", "figs_preso","tab_task-scores-study5.png"), selector = "table", zoom= 2)
...
clean_fraud_removed %>% select(task_score, practice_problems_binary, risk, conf_rank,
  ...
  tab_header(title = md("")) %>%
  opt_align_table_header(align = "left") %>% gt::gtsave(., file = here("study5","figs_preso", "summary-table-gender-study5.png"))
...
clean_fraud_removed %>% select(better_gender_guess,perc_task_gender_pract,  perc_gender_comp_M, perc_gender_comp_F, perc_gen_gender_pract) %>% tbl_summary(missing= "no") %>% 
  ...
  tab_header(title = md("")) %>%
  opt_align_table_header(align = "left") %>% gt::gtsave(., file = here("study5","figs_preso", "summary-table-beliefs-study5.png"))
...
gt::gtsave(gt_tbl, file = here("study5","figs_preso", "pre-reg-study5.png"))
