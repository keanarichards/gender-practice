...
# ggsave(here("study2", "figs_preso", "fig00_comp-choice-women-by-cond.png"), width = 7, height = 7)
...
ggsave(here("study2", "figs_preso", "fig01_better-gender-guess.png"), p, width = 7, height = 7)
...
ggsave(here("study2", "figs_preso", "fig02_perc-gender-comp.png"), p, width = 7, height = 7)
...
ggsave(here("study2", "figs_preso", "fig03_perc-gen-gender-pract.png"), p, width = 7, height = 7)
...
#   theme(axis.line = element_line(color = 'black'))
# 
# ggsave(here("study2", "figs_preso", "fig04_total-rev-count-by-gender-comp-choice.png"), p, width = 7, height = 7)
# 
...
ggsave(here("study2", "figs_preso", "fig05_pract-choice-by-gender-and-comp-choice-bar.png"), p, width = 7, height = 7)
...
ggsave(here("study2", "figs_preso", "fig06_comp-choice-by-gender-and-cond-bar.png"), p, width = 7, height = 7)
...
ggsave(here("study2", "figs_preso", "fig07_pract-choice-by-gender.png"), p, width = 7, height = 7)
...
ggsave(here("study2", "figs_preso", "fig08_perc-task-gender-pract.png"), p, width = 7, height = 7)
...
clean %>%
  ...
  opt_align_table_header(align = "left") %>% gt::gtsave(., file = here("study2","figs_preso", "demographics-table-conds-study2.png"))
...
ggsave(here("study2", "figs_preso", "pract-choice-by-gender-and-perc-task-prep-bar-study2.png"), p, width = 7, height = 7)
...
ggsave(here("study2", "figs_preso", "pract-choice-by-gender-and-perc-gen-prep-bar-study2.png"), p, width = 7, height = 7)

# creating panel plots ----------------------------------------------------

img1 <- magick::image_read(here::here("study2", "figs_preso", "fig05_pract-choice-by-gender-and-comp-choice-bar.png"))
img2 <- magick::image_read(here::here("study2", "figs_preso", "fig07_pract-choice-by-gender.png"))

panel_study2 <- magick::image_append(c(img1, img2))

image_write(panel_study2, path = here::here("study2", "figs_preso", "panel_study2.png"), format = "png")
...
tab_model(sec_exploratory16, sec_exploratory11, sec_exploratory13, file = here("study2", "figs_preso","tab_pract-choice-study2.html"),  dv.labels = c("(1)", "(2)", "(3)")) 
webshot(here("study2", "figs_preso","tab_pract-choice-study2.html"), here("study2", "figs_preso","tab_pract-choice-study2.png"), selector = "table", zoom= 2)

## Task scores as DV: 

tab_model(exploratory4, sec_exploratory26, sec_exploratory10, file = here("study2", "figs_preso","tab_task-scores-study2.html"), dv.labels = c("(1)", "(2)", "(3)"))
webshot(here("study2", "figs_preso","tab_task-scores-study2.html"), here("study2", "figs_preso","tab_task-scores-study2.png"), selector = "table", zoom= 2)


## Comp choice as DV: 

tab_model(sec_exploratory7, sec_exploratory14, exploratory1, file = here("study2", "figs_preso","tab_comp-choice-study2.html"), dv.labels = c("(1)", "(2)", "(3)"))
webshot(here("study2", "figs_preso","tab_comp-choice-study2.html"), here("study2", "figs_preso","tab_comp-choice-study2.png"), selector = "table", zoom= 2)
...
clean %>% select(task_score, comp_choice, pract_choice, risk, conf_rank,
  ...
  tab_header(title = md("")) %>%
  opt_align_table_header(align = "left") %>% gt::gtsave(., file = here("study2","figs_preso", "summary-table-gender-study2.png"))
...
clean %>% select(better_gender_guess,perc_task_gender_pract,  perc_gender_comp, perc_gen_gender_pract) %>% tbl_summary(missing= "no") %>% 
  ...
  tab_header(title = md("")) %>%
  opt_align_table_header(align = "left") %>% gt::gtsave(., file = here("study2","figs_preso", "summary-table-beliefs-study2.png"))
...
gt::gtsave(gt_tbl, file = here("study2","figs_preso", "pre-reg-study2.png"))
