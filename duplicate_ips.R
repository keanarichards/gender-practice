...
dup1 <- raw[duplicated(raw$IPAddress, fromLast = T) | duplicated(raw$IPAddress), c("MTurkID", "IPAddress", "Gender")]
...
dup2 <- raw[duplicated(raw$IPAddress, fromLast = T) | duplicated(raw$IPAddress), c("MTurkID", "IPAddress", "Gender")]
