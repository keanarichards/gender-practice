...
ggsave(here("study4", "figs", "fig06_pract-choice-by-gender.png"), p, width = 7, height = 7)
...
ggsave(here("study4", "figs", "fig07_perc-task-gender-pract.png"), p, width = 7, height = 7)
...
ggsave(here("study4", "figs", "fig08_perc-gen-gender-pract.png"), p, width = 7, height = 7)
...
ggsave(here("study4", "figs", "fig09_perc-gender-comp.png"), p, width = 7, height = 7)
...
ggsave(here("study4", "figs", "fig10_better-gender-guess.png"), p, width = 7, height = 7)
...
clean_fraud_removed %>%
  ...
  opt_align_table_header(align = "left") %>% gt::gtsave(., file = here("study4","figs", "demographics-table-conds-study4.png"))
...
ggsave(here("study4", "figs", "pract-choice-by-gender-and-perc-task-prep-bar-study4.png"), p, width = 7, height = 7)
...
ggsave(here("study4", "figs", "pract-choice-by-gender-and-perc-gen-prep-bar-study4.png"), p, width = 7, height = 7)

# creating panel plots ----------------------------------------------------

img1 <- magick::image_read(here::here("study4", "figs", "fig05_pract-choice-by-gender-and-comp-choice-bar.png"))
img2 <- magick::image_read(here::here("study4", "figs", "fig06_pract-choice-by-gender.png"))

panel_study4 <- magick::image_append(c(img1, img2))

image_write(panel_study4, path = here::here("study4", "figs", "panel_study4.png"), format = "png")
...
tab_model(sec_exploratory39, exploratory3, exploratory29, file = here("study4", "figs","tab_pract-choice-study4.html"),  dv.labels = c("(1)", "(2)", "(3)")) 
webshot(here("study4", "figs","tab_pract-choice-study4.html"), here("study4", "figs","tab_pract-choice-study4.png"), selector = "table", zoom= 2)

## Task scores as DV: 

tab_model(exploratory19, exploratory46, exploratory20, file = here("study4", "figs","tab_task-scores-study4.html"), dv.labels = c("(1)", "(2)", "(3)"))
webshot(here("study4", "figs","tab_task-scores-study4.html"), here("study4", "figs","tab_task-scores-study4.png"), selector = "table", zoom= 2)


## Comp choice as DV: 

tab_model(exploratory16, hypothesis3a, hypothesis3c, file = here("study4", "figs","tab_comp-choice-study4.html"), dv.labels = c("(1)", "(2)", "(3)"))
webshot(here("study4", "figs","tab_comp-choice-study4.html"), here("study4", "figs","tab_comp-choice-study4.png"), selector = "table", zoom= 2)
...
clean_fraud_removed %>% select(task_score, comp_choice, practice_problems_binary, risk, conf_rank,
  ...
  tab_header(title = md("")) %>%
  opt_align_table_header(align = "left") %>% gt::gtsave(., file = here("study4","figs", "summary-table-gender-study4.png"))
...
clean_fraud_removed %>% select(better_gender_guess,perc_task_gender_pract,  perc_gender_comp, perc_gen_gender_pract) %>% tbl_summary(missing= "no") %>% 
  ...
  tab_header(title = md("")) %>%
  opt_align_table_header(align = "left") %>% gt::gtsave(., file = here("study4","figs", "summary-table-beliefs-study4.png"))
...
gt::gtsave(gt_tbl, file = here("study4","figs", "pre-reg-study4.png"))
...
clean_fraud_removed %>%
  ...
  opt_align_table_header(align = "left") %>% gt::gtsave(., file = here("study4","figs", "demographics-table-gender-study4.png"))
