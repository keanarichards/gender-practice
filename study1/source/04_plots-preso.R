...
ggsave(here("study1", "figs_preso", "fig00_comp-choice-by-gender-and-cond-bar.png"), p, width = 7, height = 7)
...
ggsave(here("study1", "figs_preso", "fig01_pract-choice-by-gender-and-comp-choice-bar.png"), p, width = 7, height = 7)
...
# 
# ggsave(here("study1", "figs_preso", "fig02_total-rev-count-by-gender-comp-choice.png"), p, width = 7, height = 7)
# 
# 
...
ggsave(here("study1", "figs_preso", "fig03_perc-task-gender-pract.png"), p, width = 7, height = 7)
...
ggsave(here("study1", "figs_preso", "fig04_better-gender-guess.png"), p, width = 7, height = 7)
...
ggsave(here("study1", "figs_preso", "fig05_perc-gender-comp.png"), p, width = 7, height = 7)
...
ggsave(here("study1", "figs_preso", "fig06_perc-gen-gender-pract.png"), p, width = 7, height = 7)
...
ggsave(here("study1", "figs_preso", "fig07_pract-choice-by-gender.png"), p, width = 7, height = 7)
...
#   theme_apa()+theme(legend.position = "none") + guides (fill = "none")
# 
# ggsave(here("study1", "figs_preso", "fig08_total-rev-count-by-gender.png"), p, width = 7, height = 7)
# 
# 
# models  -----------------------------------------------------------------
...
tab_model(sec_exploratory17, sec_exploratory2, sec_exploratory14, file = here("study1", "figs_preso","tab_pract-choice-study1.html"),  dv.labels = c("(1)", "(2)", "(3)")) 
webshot(here("study1", "figs_preso","tab_pract-choice-study1.html"), here("study1", "figs_preso","tab_pract-choice-study1.png"), selector = "table", zoom= 2)

## Task scores as DV: 

tab_model(sec_exploratory9, sec_exploratory20, sec_exploratory12, file = here("study1", "figs_preso","tab_task-scores-study1.html"), dv.labels = c("(1)", "(2)", "(3)"))
webshot(here("study1", "figs_preso","tab_task-scores-study1.html"), here("study1", "figs_preso","tab_task-scores-study1.png"), selector = "table", zoom= 2)


## Comp choice as DV: 

tab_model(sec_exploratory6, primary_hyp1, sec_exploratory11, file = here("study1", "figs_preso","tab_comp-choice-study1.html"), dv.labels = c("(1)", "(2)", "(3)"))
webshot(here("study1", "figs_preso","tab_comp-choice-study1.html"), here("study1", "figs_preso","tab_comp-choice-study1.png"), selector = "table", zoom= 2)
...
gt::gtsave(gt_tbl, file = here("study1","figs_preso", "pre-reg-study1.png"))
...
clean %>% select(task_score, comp_choice, pract_choice, risk, conf_rank,
  ...
  tab_header(title = md("")) %>%
  opt_align_table_header(align = "left") %>% gt::gtsave(., file = here("study1","figs_preso", "summary-table-gender-study1.png"))
...
clean %>% select(better_gender_guess,perc_task_gender_pract,  perc_gender_comp, perc_gen_gender_pract) %>% tbl_summary(missing= "no") %>% 
  ...
  tab_header(title = md("")) %>%
  opt_align_table_header(align = "left") %>% gt::gtsave(., file = here("study1","figs_preso", "summary-table-beliefs-study1.png"))
...
clean %>%
  ...
  opt_align_table_header(align = "left") %>% gt::gtsave(., file = here("study1","figs_preso", "demographics-table-conds-study1.png"))


# creating panel plots ----------------------------------------------------

img1 <- magick::image_read(here::here("study1", "figs_preso", "fig01_pract-choice-by-gender-and-comp-choice-bar.png"))
img2 <- magick::image_read(here::here("study1", "figs_preso", "fig07_pract-choice-by-gender.png"))

panel_study1 <- magick::image_append(c(img1, img2))

image_write(panel_study1, path = here::here("study1", "figs_preso", "panel_study1.png"), format = "png")
...
ggsave(here("study1", "figs_preso", "pract-choice-by-gender-and-perc-task-prep-bar-study1.png"), p, width = 7, height = 7)
...
ggsave(here("study1", "figs_preso", "pract-choice-by-gender-and-perc-gen-prep-bar-study1.png"), p, width = 7, height = 7)
